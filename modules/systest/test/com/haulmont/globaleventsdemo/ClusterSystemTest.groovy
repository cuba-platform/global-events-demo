...
class ClusterSystemTest {
    ...
    void testBeanEvent() {
        ...
        assertEquals(2, rows.findAll { it.receiver == 'com.haulmont.globaleventsdemo.core.FooCoreBean' }.size())
        assertEquals(3, rows.findAll { it.receiver == 'com.haulmont.globaleventsdemo.web.FooWebBean' }.size())
