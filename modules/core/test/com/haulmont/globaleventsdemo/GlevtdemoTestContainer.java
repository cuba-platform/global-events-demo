...
public class GlevtdemoTestContainer extends TestContainer {

    public GlevtdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/globaleventsdemo/app.properties",
    ...
    public static class Common extends GlevtdemoTestContainer {

        public static final GlevtdemoTestContainer.Common INSTANCE = new GlevtdemoTestContainer.Common();
